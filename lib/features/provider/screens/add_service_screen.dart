    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: const Text("Service registered successfully!", style: TextStyle(fontWeight: FontWeight.w600)),
  ...
  void _showErrorDialog(String message) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: const Text("Error Encountered", style: TextStyle(fontWeight: FontWeight.w800, color: textDark)),
        content: Text(message),
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(18)),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: const Text("OK", style: TextStyle(fontWeight: FontWeight.w700, color: primaryColor)),
          ),
        ],
      ),
    );
  ...
  void _showConfirmationDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        backgroundColor: cardBgColor,
        surfaceTintColor: Colors.transparent,
        title: const Text("Confirm Service Entry", style: TextStyle(fontWeight: FontWeight.w800, color: textDark)),
      ...
      body: _isUploading
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError || !snapshot.hasData) {
            return const Center(child: Text("Failed to load category dependencies.", style: TextStyle(color: textMuted, fontWeight: FontWeight.w500)));
          }
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    "Service Details",
                    style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: primaryColor, letterSpacing: 0.5),
                  ),
                  ...
                  _buildPremiumField(
                    ...
                    hint: "Describe your service parameters in full detail...",
                    maxLines: 4,
  ...
  Widget _buildPremiumField({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        labelStyle: const TextStyle(color: textMuted, fontWeight: FontWeight.w600, fontSize: 14),
        prefixIcon: icon != null ? Icon(icon, size: 20, color: textMuted) : null,
        prefixText: prefixText,
        prefixStyle: const TextStyle(fontWeight: FontWeight.bold, color: textDark),
        filled: true,
        ...
        errorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: primaryColor)),
        focusedErrorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: primaryColor, width: 1.5)),
      ),
      validator: (value) {
  ...
  Widget _buildCategoryDropdown(List<String> categories) {
    return DropdownButtonFormField<String>(
      ...
      items: categories
        ...
        value: category,
        child: Text(category, style: const TextStyle(fontSize: 14.5, fontWeight: FontWeight.w500)),
      ))
          .toList(),
      onChanged: (value) {
        setState(() {
      ...
      decoration: InputDecoration(
        labelText: "Category",
        labelStyle: const TextStyle(color: textMuted, fontWeight: FontWeight.w600, fontSize: 14),
        prefixIcon: const Icon(Icons.category_outlined, size: 20, color: textMuted),
        filled: true,
        fillColor: Colors.white,
        contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
        enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: Color(0xFFEEEEEE))),
