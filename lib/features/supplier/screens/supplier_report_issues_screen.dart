...
class SupplierReportIssuesScreen extends StatefulWidget {
  const SupplierReportIssuesScreen({super.key});

  @override
  State<SupplierReportIssuesScreen> createState() => _SupplierReportIssuesScreenState();
}

class _SupplierReportIssuesScreenState extends State<SupplierReportIssuesScreen> {
