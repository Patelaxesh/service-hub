...
class SupplierEarningsAndPaymentScreen extends StatefulWidget {
  const SupplierEarningsAndPaymentScreen({super.key});

  @override
  State<SupplierEarningsAndPaymentScreen> createState() =>
      _SupplierEarningsAndPaymentScreenState();
}

class _SupplierEarningsAndPaymentScreenState
    extends State<SupplierEarningsAndPaymentScreen> {
